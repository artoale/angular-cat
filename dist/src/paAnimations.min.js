    ...
    return {
        ...
        controller: ['$q', '$scope', '$attrs', function ($q, $scope, $attrs) {
            ...
            var animations = [],
                ...
                clear = function clear(isDisabled) {
                if (status === 'RUNNING') {
                    deferred.resolve();
                }
                ...
                return $q.all(animations.map(function (animation) {
                    return animation.controller.clear(isDisabled);
                })).then(function () {
                    setStatus('READY');
                });
            },
                setUp = function setUp(isDisabled) {
                setStatus('READY');
            },
                runAnimation = function runAnimation() {
...
mod.directive('paVisible', ['$window', '$parse', function ($window, $parse) {
    return {
        restrict: 'A',
